...
module.exports.attach = function(passport, app, config, pluginConfig, logger) {
  ...
  // Attach our routes used for authentication to the whitelist allowing
  // unauthed users to reach them.
  config.routeWhiteList.push('/auth/google');
  config.routeWhiteList.push('/oauth2callback');
